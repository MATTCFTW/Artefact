      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new t(this, 'object' == typeof e ? e : null)), o.default(this).data('bs.dropdown', n)),
              'string' == typeof e)
            ) {
        ...
        (t._clearMenus = function (e) {
          if (!e || (3 !== e.which && ('keyup' !== e.type || 9 === e.which)))
            for (
              var n = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), i = 0, a = n.length;
              i < a;
              i++
            ) {
        ...
        (t._dataApiKeydownHandler = function (e) {
          if (
            !(/input|textarea/i.test(e.target.tagName)
              ? 32 === e.which ||
                (27 !== e.which &&
                  ((40 !== e.which && 38 !== e.which) || o.default(e.target).closest('.dropdown-menu').length))
              : !I.test(e.which)) &&
            !this.disabled &&
            ...
            if (i || 27 !== e.which) {
              if ((e.preventDefault(), e.stopPropagation(), !i || 27 === e.which || 32 === e.which))
                return (
                  27 === e.which && o.default(n.querySelector('[data-toggle="dropdown"]')).trigger('focus'),
        ...
        (i._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new i(this, n)), o.default(this).data('bs.popover', e)), 'string' == typeof t)
            ) {
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new t(this, 'object' == typeof e && e)), o.default(this).data('bs.scrollspy', n)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof n[e]) throw new TypeError('No method named "' + e + '"');
              n[e]();
