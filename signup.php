  ...
  <div class="container">
    <div class="row justify-content-md-center nav-padding">
      <div class="col-md-6 col-md-auto register-box">
        <h1 class="text-center text-red">Register</h1>
        <h2 class="text-center register-h2">Enter details to create an account</h2>
        <hr>
        <form action="<?php echo $siteUrl; ?>/includes/signup.inc.php" method="POST">
          <div class="form-row">
            <div class="col-md-12">
              <input type="text" class="form-control-lg form-control text-input" name="f_name" placeholder="First name">
            </div>
            <div class="col-md-12">
              <input type="text" class="form-control-lg form-control text-input" name="l_name" placeholder="Last name">
            </div>
            <div class="col-md-12">
        ...
        <h5>Already have an account?</h5><a href="/login.php" class="clickhere-href">Click here</a>
